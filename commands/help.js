...
const readMore = String.fromCharCode(8206).repeat(4001); // creates the "read more" effect


// ᴄᴏᴍᴍᴀɴᴅ ᴄᴀᴛᴇɢᴏʀɪᴇꜱ
const GENERAL_COMMANDS = ['ʜᴇʟᴘ', 'ᴍᴇɴᴜ', 'ᴘɪɴɢ', 'ᴀʟɪᴠᴇ', 'ᴛᴛꜱ', 'ᴏᴡɴᴇʀ', 'ᴊᴏᴋᴇ', 'Qᴜᴏᴛᴇ', 'ꜰᴀᴄᴛ', 'ᴡᴇᴀᴛʜᴇʀ', 'ɴᴇᴡꜱ', 'ᴀᴛᴛᴘ', 'ʟʏʀɪᴄꜱ', '8ʙᴀʟʟ', 'ɢʀᴏᴜᴘɪɴꜰᴏ', 'ꜱᴛᴀꜰꜰ', 'ᴀᴅᴍɪɴꜱ', 'ᴠᴠ', 'ᴛʀᴛ', 'ꜱꜱ', 'ᴊɪᴅ', 'ᴜʀʟ'];
...
const GITHUB_COMMANDS = [ 'ꜱᴄʀɪᴘᴛ', 'ɢɪᴛᴄʟᴏɴᴇ', 'ʀᴇᴘᴏ'];
// ꜰᴜɴᴄᴛɪᴏɴ ᴛᴏ ᴄᴏᴜɴᴛ ᴄᴏᴍᴍᴀɴᴅꜱ
function getCommandCount(commands) {
    return commands.length;
}

// ꜰᴜɴᴄᴛɪᴏɴ ᴛᴏ ɢᴇᴛ ᴘᴜꜱʜɴᴀᴍᴇ
function getPushname(message) {
    return message.pushName || message.key.participant?.split('@')[0] || 'No Name';
}

// ꜰᴜɴᴄᴛɪᴏɴ ᴛᴏ ɢᴇᴛ ᴛᴏᴛᴀʟ ᴄᴏᴍᴍᴀɴᴅꜱ
